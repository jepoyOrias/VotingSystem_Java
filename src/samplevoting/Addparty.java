...
public class Addparty extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        partylistTxt = new javax.swing.JTextField();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(partylistTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(136, 136, 136)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(partylistTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        String partylist=partylistTxt.getText().toUpperCase();
        if(partylistTxt.getText().equals("")){
        ...
        {
           try{
           String sql="SELECT * FROM partylist WHERE partylist='"+partylistTxt.getText()+"'";
            PreparedStatement pst = conn.prepareStatement(sql);
            ResultSet rs = pst.executeQuery(sql);
           
            if(rs.next()){
                JOptionPane.showMessageDialog(null,"This Partylist is Already in The Databse");
             partylistTxt.setText("");
            
            }
       else
            {
           sql = "INSERT INTO partylist (partylist) VALUES (?)";
            pst = conn.prepareStatement(sql);
            pst.setString(1, partylistTxt.getText());
            pst.execute();
            JOptionPane.showMessageDialog(null, "Partylist has been added!");
         
        dispose();
        }}
        catch(Exception e){
            JOptionPane.showMessageDialog(null,"Partylist not add to database");
        }
        }
    ...
    private javax.swing.JTextField partylistTxt;
